      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-16 pt-8 border-t border-gray-200">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            {chapterNumber > 1 ? (
              <Link href={chapterNumber === 2 ? "/plantar-fasciitis/race-training/why-standard-advice-fails" : `/guides/plantar-fasciitis/${guideSlug}/chapter-${chapterNumber - 1}`}>
            ...
            {chapterNumber < totalChapters ? (
              <Link href={chapterNumber === 1 ? "/plantar-fasciitis/race-training/know-what-youre-dealing-with" : `/guides/plantar-fasciitis/${guideSlug}/chapter-${chapterNumber + 1}`}>
