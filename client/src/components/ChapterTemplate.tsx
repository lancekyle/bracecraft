      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-16 pt-8 border-t border-gray-200">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            {chapterNumber > 0 ? (
              <Link href={chapterNumber === 1 ? "/plantar-fasciitis/race-training/introduction" : chapterNumber === 2 ? "/plantar-fasciitis/race-training/why-standard-advice-fails" : chapterNumber === 3 ? "/plantar-fasciitis/race-training/know-what-youre-dealing-with" : chapterNumber === 4 ? "/plantar-fasciitis/race-training/race-distance-modifications" : chapterNumber === 5 ? "/plantar-fasciitis/race-training/sport-specific-protocols" : chapterNumber === 6 ? "/plantar-fasciitis/race-training/gear-strategy" : chapterNumber === 7 ? "/plantar-fasciitis/race-training/training-load-management" : chapterNumber === 8 ? "/plantar-fasciitis/race-training/race-day-strategy" : `/guides/plantar-fasciitis/${guideSlug}/chapter-${chapterNumber - 1}`}>
