                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Link href={chapter.id === 0 ? "/plantar-fasciitis/race-training/introduction" : chapter.id === 1 ? "/plantar-fasciitis/race-training/why-standard-advice-fails" : chapter.id === 2 ? "/plantar-fasciitis/race-training/know-what-youre-dealing-with" : chapter.id === 3 ? "/plantar-fasciitis/race-training/race-distance-modifications" : chapter.id === 4 ? "/plantar-fasciitis/race-training/sport-specific-protocols" : chapter.id === 5 ? "/plantar-fasciitis/race-training/gear-strategy" : chapter.id === 6 ? "/plantar-fasciitis/race-training/training-load-management" : chapter.id === 7 ? "/plantar-fasciitis/race-training/race-day-strategy" : chapter.id === 8 ? "/plantar-fasciitis/race-training/conclusion" : `/guides/plantar-fasciitis/training-guide/chapter-${chapter.id}`}>
                          <Button 
