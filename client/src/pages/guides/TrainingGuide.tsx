                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Link href={chapter.id === 1 ? "/plantar-fasciitis/race-training/why-standard-advice-fails" : chapter.id === 2 ? "/plantar-fasciitis/race-training/know-what-youre-dealing-with" : chapter.id === 3 ? "/plantar-fasciitis/race-training/race-distance-modifications" : `/guides/plantar-fasciitis/training-guide/chapter-${chapter.id}`}>
                          <Button 
